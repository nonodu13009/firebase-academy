...
export const products: Product[] = [
  // Build
  {
    ...
    name: "Authentication",
    category: "build",
    description: "Plateforme d'identité sécurisée",
  ...
  },
  {
    ...
    category: "build",
    description: "Base de données NoSQL cloud évolutive",
  ...
  },
  {
    ...
    category: "build",
    description: "Base de données NoSQL temps réel",
  ...
  },
  {
    ...
    category: "build",
    description: "Hébergement web statique et dynamique",
  ...
  },
  {
    ...
    name: "App Hosting",
    category: "build",
    description: "Hébergement d'apps full-stack",
  ...
  },
  {
    ...
    name: "Security Rules",
    category: "build",
    description: "Règles de sécurité des données",
  ...
  },
  {
    ...
    name: "Extensions",
    category: "build",
    description: "Extensions Firebase préconstruites",
  ...
  },
  {
    ...
    name: "Emulator Suite",
    category: "build",
    description: "Suite d'émulateurs locaux",
  ...
  },
  {
    ...
    name: "Crashlytics",
    category: "run",
    description: "Rapport de plantages en temps réel",
  ...
  },
  {
    ...
    name: "Remote Config",
    category: "run",
    description: "Configuration à distance",
  ...
  },
  {
    ...
    category: "run",
    description: "Messages intégrés à l'application",
  ...
  },
  {
    ...
    name: "Google AdMob",
    category: "run",
    description: "Monétisation publicitaire",
  ...
  // IA
  {
    ...
    category: "ia",
    description: "Intégration des modèles Gemini",
